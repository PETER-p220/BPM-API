    ...
    public function store(Request $request)
    {
        try {
            $validatedData = $request->validate([
                ...
                'submission_mode' => 'nullable|string|max:100',
            ...
            $tender = Tender::create([
                ...
                'procurement_method' => $validatedData['procurement_method'] ?? null,
                'submission_mode' => $validatedData['submission_mode'] ?? null,
                'bid_currency' => $validatedData['bid_currency'] ?? 'TZS',
                'estimated_value' => $validatedData['estimated_value'] ?? null,
                'tender_fee' => $validatedData['tender_fee'] ?? null,
                'bid_security_required' => (bool) ($validatedData['bid_security_required'] ?? false),
                'bid_security_amount' => $validatedData['bid_security_amount'] ?? null,
                'site_visit_date' => $validatedData['site_visit_date'] ?? null,
                'clarification_deadline' => $validatedData['clarification_deadline'] ?? null,
                'contract_duration' => $validatedData['contract_duration'] ?? null,
                'scope_summary' => $validatedData['scope_summary'] ?? null,
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $tender->update([
                ...
                'procurement_method' => $validatedData['procurement_method'] ?? $tender->procurement_method,
                'submission_mode' => $validatedData['submission_mode'] ?? $tender->submission_mode,
                'bid_currency' => $validatedData['bid_currency'] ?? $tender->bid_currency,
                'estimated_value' => $validatedData['estimated_value'] ?? $tender->estimated_value,
                'tender_fee' => $validatedData['tender_fee'] ?? $tender->tender_fee,
                'bid_security_required' => array_key_exists('bid_security_required', $validatedData)
                    ? (bool) $validatedData['bid_security_required']
                    : $tender->bid_security_required,
                'bid_security_amount' => $validatedData['bid_security_amount'] ?? $tender->bid_security_amount,
                'site_visit_date' => $validatedData['site_visit_date'] ?? $tender->site_visit_date,
                'clarification_deadline' => $validatedData['clarification_deadline'] ?? $tender->clarification_deadline,
                'contract_duration' => $validatedData['contract_duration'] ?? $tender->contract_duration,
                'scope_summary' => $validatedData['scope_summary'] ?? $tender->scope_summary,
                'eligibility_criteria' => $validatedData['eligibility_criteria'] ?? $tender->eligibility_criteria,
